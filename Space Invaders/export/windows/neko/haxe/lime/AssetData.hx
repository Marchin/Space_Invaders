...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/Shield1b.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Shield1c.png", "assets/images/Shield1c.png");
			type.set ("assets/images/Shield1c.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/Shield2b.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Shield2c.png", "assets/images/Shield2c.png");
			type.set ("assets/images/Shield2c.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/Shield3b.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Shield3c.png", "assets/images/Shield3c.png");
			type.set ("assets/images/Shield3c.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/Shield4b.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Shield4c.png", "assets/images/Shield4c.png");
			type.set ("assets/images/Shield4c.png", Reflect.field (AssetType, "image".toUpperCase ()));
